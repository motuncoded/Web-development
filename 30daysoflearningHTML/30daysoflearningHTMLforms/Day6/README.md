...
<form>
  ...
  <textarea id="description" name="description" placeholder="Enter the description..."></textarea><br>
...
<body>
  ...
  <form action="/submit" method="POST">
    ...
    <textarea id="comment" name="comment" rows="6" cols="50" maxlength="200" placeholder="Type your comment here..." required></textarea><br>
...
<form>
  ...
  <textarea id="dynamic-textarea" rows="4" oninput="autoResize()" placeholder="Type something..."></textarea><br>
</form>
```
